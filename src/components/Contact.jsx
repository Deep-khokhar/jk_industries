            ...
            <div className="flex flex-col justify-between lg:py-5">
              <div>
                ...
                <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white text-justify">
                  We understand the value of each customer gained by us, so
                  don’t hesitate to contact us. Drop us a message now and we
                  promise we will response you under few minutes.
                </p>
                <img
